...
class KeyBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,title: const  Text("KeyBox",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600),),),
      body: SafeArea(
       ...
       const      SizedBox(height: 20,),
        ...
        RichText(text: const  TextSpan(children: [
          ...
          TextSpan(
            ...
            style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600,color: Color(0xffff36a21))
          ),
          TextSpan(
